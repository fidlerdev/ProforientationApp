...
import { Title, Card, Div, Link, Text, Counter, List, Cell, ModalPageHeader, IS_PLATFORM_IOS, PanelHeaderButton } from '@vkontakte/vkui';
...
export { ModalResult_1, ModalResult_2, ModalResult_3 , ModalResult_4, ModalResult_5 } ;